 ...
 */
export async function loadSlideRelationships(zip, slideFileName, context) {
    ...
    const layoutRel = Object.values(slideResObj).find(rel => rel.type === 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideLayout');
    if (layoutRel) {
        // Load slide layout
        ...
        if (slideLayoutContent) {
            ...
            if (layoutRels) {
                ...
                const masterRel = Object.values(layoutResObj).find(rel => rel.type === 'http://schemas.openxmlformats.org/officeDocument/2006/relationships/slideMaster');
                if (masterRel) {
                    // Load slide master
 ...
 */
export function getPositionNode(element, elementType, context) {
    const result = {};
    // Get slide node
...
//# sourceMappingURL=slideRelationships.js.map